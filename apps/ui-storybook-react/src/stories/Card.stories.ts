...
export const WithWarnButton: Story = {
	args: {
		...
		content:
			"Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.",
		buttons:[
			{ label: "Warn", href: "/", icon: HiInformationCircle, color: "warning" }
		]
	}
};
...
export const CTA: Story = {
	args: {
		children: "Card",
		type: "cta",
		content: "Stay up to date and move work forward with Flowbite on iOS & Android. Download the app today.",
		buttons: [
			{ 
				label: "Mac App Store",
