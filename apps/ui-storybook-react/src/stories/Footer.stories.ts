		...
		body: createElement(
			...
			createElement(
				...
				createElement(
					...
					createElement(FlowbiteFooter.Icon, { href: "#", icon: Home }),
					createElement(FlowbiteFooter.Icon, { href: "#", icon: MailBox }),
					createElement(FlowbiteFooter.Icon, { href: "#", icon: Music }),
					createElement(FlowbiteFooter.Icon, { href: "#", icon: File })
				)
			)
		)
	}
