...
import React, { memo, useCallback, useMemo, type JSX, type ReactNode } from "react";
import type { SidebarProps, SidebarItem as SidebarItemType, BadgeColor } from "./sidebarProps";
import { PRIMARY, SUCCESS, WARNING, FAILURE, INFO } from "../../shared/constants/colors";
        ...
        ({
                ...
                const renderItem = useCallback((item: SidebarItemType): ReactNode => {
                        ...
                        if (subItems && subItems.length > 0) {
                                return (
                                        <SidebarCollapse key={itemKey} icon={icon} label={label}>
