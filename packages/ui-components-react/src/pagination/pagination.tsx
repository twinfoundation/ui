...
import { createTheme, Pagination as FlowbitePagination } from "flowbite-react";
...
export const Pagination = memo(({ onPageChange, ...rest }: PaginationProps): JSX.Element => {
	...
	return (
		<FlowbitePagination theme={customTheme.pagination} {...rest} onPageChange={handlePageChange} />
	);
});
