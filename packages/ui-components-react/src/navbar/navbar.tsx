...
import { Navbar as FlowbiteNavbar, Dropdown as FlowbiteDropdown, Avatar as FlowbiteAvatar } from "flowbite-react";
			...
			<FlowbiteNavbar fluid rounded>
				...
				<div className="flex md:order-2">
					<FlowbiteDropdown
						...
						inline
						label={
							<FlowbiteAvatar alt="User settings" img="https://flowbite.com/docs/images/people/profile-picture-5.jpg" rounded />
						}
					>
