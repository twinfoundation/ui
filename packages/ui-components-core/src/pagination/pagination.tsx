 ...
 */
export const Pagination = memo(({ onPageChange, layout, ...rest }: PaginationProps): JSX.Element => {
	...
	// Filter out unsupported layout values
	const filteredLayout = layout === "table" ? "pagination" : layout;

	return <FlowbitePagination theme={customTheme} {...rest} layout={filteredLayout} onPageChange={handlePageChange} />;
});
